...
// Menu
// --------------------------------------------------------------------------
// Descricao   : Gerenciador de menus genericos com Image Splash
...
function AddNewSplashButton(IMGSrc, IMGAlt) {
  ...
  if (br == "n3") {
    ...
    cmdsplash[cmdcounter].src = IMGRoot + IMGSrc + IMGSplash;
    ...
    imgsrc = imgsrc + "<img src='" + IMGRoot + IMGSrc + strStatus + "' width=" + IMGWidth + " height=" + IMGHeight + " alt='" + IMGAlt + "' name=scmd" + cmdcounter + ">"
    ...
    imgsrc = "<a href='" + AHREF + "' target=" + ATarget + " name=acmd" + cmdcounter + ">"
    imgsrc = imgsrc + "<img src='" + IMGRoot + IMGSrc + strStatus + "' width=" + IMGWidth + " height=" + IMGHeight + " alt='" + IMGAlt + "' name=scmd" + cmdcounter + " border=0></a>"
